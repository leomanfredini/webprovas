...
<?php echo $this->Form->create('Exam'); ?>
	<fieldset>
		...
		<?php
			...
			echo $this->Form->input('questions_selected', ['type'=>'hidden','label' => 'Questões (somente para referências)', 'value' => implode(' ', $this->Session->read('Exams_select')), 'readonly' => 'readonly']);
